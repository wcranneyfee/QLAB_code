...
BvsI = pd.read_csv('../Data/Qlab2/Zeeman Effect/Current_vs_Field.csv')
...
unsplit_df = pd.read_csv("../Data/Qlab2/Zeeman Effect/6A_splitting.csv")
split_df = pd.read_csv("../Data/Qlab2/Zeeman Effect/6A_no_splitting.csv")
...
split_df = pd.read_csv("../Data/Qlab2/Zeeman Effect/3A_splitting.csv")
unsplit_df = pd.read_csv("../Data/Qlab2/Zeeman Effect/3A_no_splitting.csv")
plt.plot(unsplit_df['alpha'], unsplit_df['I'], color='blue', linewidth=0.5, label='Unsplit')
plt.plot(split_df['alpha'], split_df['I'], color='red', linewidth=0.5, label='Split')
plt.legend()
